...
const PerformancePrediction = () => {  
  ...
  const handleExportToCsv = async () => {
    ...
    axios.post("https://sblab-vm06.sblab02.nsu.ru:8080/predict-input-data?range=true&return_csv=true",
    {
      year_from: 1960,
  ...
  const handleSubmit = async () => {
    ...
    axios.post("https://sblab-vm06.sblab02.nsu.ru:8080/predict-input-data?range=true",
    {
      year_from: 1960,
      year_to: Number(formData.selectedYear.value.getFullYear())
    })
